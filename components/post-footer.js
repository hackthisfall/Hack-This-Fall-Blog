...
export default function PostFooter({ title, coverImage, date, author }) {
  return (
    <>
      <div className="flex flex-col md:flex-row border items-center px-5 py-3 md:py-5 md:px-10 rounded-xl font-poppins text-black-accent">
        ...
        <div className="max-w-2xl mx-auto border-none md:border-l pl-10 py-4">
